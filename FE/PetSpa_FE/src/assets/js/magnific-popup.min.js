! function(e) {
    ...
    c.magnificPopup = {
        ...
        proto: e.prototype = {
            ...
            open: function(e) {
                ...
                if (!f.isOpen) {
                    ...
                    }, 16), f.isOpen = !0, f.updateSize(r), p(C), e
                }
                f.updateItemHTML()
            },
            close: function() {
                f.isOpen && (p(v), f.isOpen = !1, f.st.removalDelay && !f.isLowIE && f.supportsTransition ? (f._addClassToMFP(F), setTimeout(function() {
                    f._close()
            ...
            updateSize: function(e) {
                var t;
                f.isIOS ? (t = document.documentElement.clientWidth / window.innerWidth, t = window.innerHeight * t, f.wrap.css("height", t), f.wH = t) : f.wH = e || I.height(), f.fixedContentPos || f.wrap.css("height", f.wH), p("Resize")
            },
            updateItemHTML: function() {
                var e = f.items[f.index],
                    t = (f.contentContainer.detach(), f.content && f.content.detach(), (e = e.parsed ? e : f.parseEl(f.index)).type),
                    n = (p("BeforeChange", [f.currItem ? f.currItem.type : "", t]), f.currItem = e, f.currTemplate[t] || (n = !!f.st[t] && f.st[t].markup, p("FirstMarkupParse", n), f.currTemplate[t] = !n || c(n)), i && i !== e.type && f.container.removeClass("mfp-" + i + "-holder"), f["get" + t.charAt(0).toUpperCase() + t.slice(1)](e, f.currTemplate[t]));
        ...
        a();
        var t, n, o, i = c(this);
        return "string" == typeof e ? "open" === e ? (t = s ? i.data("magnificPopup") : i[0].magnificPopup, n = parseInt(arguments[1], 10) || 0, o = t.items ? t.items[n] : (o = i, (o = t.delegate ? o.find(t.delegate) : o).eq(n)), f._openClick({
            mfpEl: o
        }, i, t)) : f.isOpen && f[e].apply(f, Array.prototype.slice.call(arguments, 1)) : (e = c.extend(!0, {}, e), s ? i.data("magnificPopup", e) : i[0].magnificPopup = e, f.addGroup(i, e)), i
    };
    ...
    c.magnificPopup.registerModule(_, {
        ...
        proto: {
            ...
            getInline: function(e, t) {
                var n, o, i;
                return j(), e.src ? (n = f.st.inline, (o = c(e.src)).length ? ((i = o[0].parentNode) && i.tagName && (k || (x = n.hiddenClass, k = u(x), x = "mfp-" + x), T = o.after(k).detach().removeClass(x)), f.updateStatus("ready")) : (f.updateStatus("error", n.tNotFound), o = c("<div>")), e.inlineElement = o) : (f.updateStatus("ready"), f._parseMarkup(t, {}, e), t)
            }
        }
    });
    ...
    c.magnificPopup.registerModule(E, {
        ...
        proto: {
            initAjax: function() {
                f.types.push(E), S = f.st.ajax.cursor, d(l + "." + E, N), d("BeforeChange." + E, N)
            },
            getAjax: function(o) {
                ...
                var e = c.extend({
                    ...
                    success: function(e, t, n) {
                        ...
                        p("ParseAjax", e), f.appendContent(c(e.data), E), o.finished = !0, P(), f._setFocus(), setTimeout(function() {
                            f.wrap.addClass(b)
                        }, 16), f.updateStatus("ready"), p("AjaxContentAdded")
                    },
                    error: function() {
                        P(), o.finished = o.loadError = !0, f.updateStatus("error", f.st.ajax.tError.replace("%url%", o.src))
                    }
                }, f.st.ajax.settings);
        ...
        proto: {
            initImage: function() {
                ...
                f.types.push("image"), d(C + t, function() {
                    ...
                    e.cursor && c(document.body).removeClass(e.cursor), I.off("resize" + w)
            ...
            findImageSize: function(t) {
                function n(e) {
                    z && clearInterval(z), z = setInterval(function() {
                        return 0 < i.naturalWidth ? void f._onImageHasSize(t) : (200 < o && clearInterval(z), void(3 === ++o ? n(10) : 40 === o ? n(50) : 100 === o && n(500)))
                    }, e)
                }
                var o = 0,
                    i = t.img[0];
        ...
        proto: {
            initZoom: function() {
                var e, t, n, o, i, a, r = f.st.zoom,
                    s = ".zoom";
                r.enabled && f.supportsTransition && (o = r.duration, i = function(e) {
        ...
        H = (c.magnificPopup.registerModule(L, {
            ...
            proto: {
                initGallery: function() {
                    var a = f.st.gallery,
                        e = ".mfp-gallery";
                    return f.direction = !0, !(!a || !a.enabled) && (h += " mfp-gallery", d(C + e, function() {
                        ...
                        var e, t;
                        1 < f.items.length && a.arrows && !f.arrowLeft && (t = a.arrowMarkup, e = f.arrowLeft = c(t.replace(/%title%/gi, a.tPrev).replace(/%dir%/gi, "left")).addClass(r), t = f.arrowRight = c(t.replace(/%title%/gi, a.tNext).replace(/%dir%/gi, "right")).addClass(r), e.click(function() {
                            f.prev()
                        }), t.click(function() {
                            f.next()
    ...
    c.magnificPopup.registerModule(H, {
        ...
        proto: {
            initRetina: function() {
                var n, o;
                1 < window.devicePixelRatio && (n = f.st.retina, o = n.ratio, 1 < (o = isNaN(o) ? o() : o) && (d("ImageHasSize." + H, function(e, t) {
                    t.img.css({
