!function(t, e) {
    ...
    return function() {
                    ...
                    !function(e) {
                        ...
                        function b() {
                            ...
                            this._initBody = function(t) {
                                ...
                                this._bodyInit = t,
                                t ? "string" == typeof t ? this._bodyText = t : r && Blob.prototype.isPrototypeOf(t) ? this._bodyBlob = t : s && FormData.prototype.isPrototypeOf(t) ? this._bodyFormData = t : n && URLSearchParams.prototype.isPrototypeOf(t) ? this._bodyText = t.toString() : a && r && (e = t) && DataView.prototype.isPrototypeOf(e) ? (this._bodyArrayBuffer = m(t.buffer),
                        ...
                        function O(t, n) {
                            return new Promise((function(i, s) {
                                ...
                                "responseType"in u && (r ? u.responseType = "blob" : a && l.headers.get("Content-Type") && -1 !== l.headers.get("Content-Type").indexOf("application/octet-stream") && (u.responseType = "arraybuffer")),
        ...
        return function() {
            ...
            function h(t, e, o) {
                for (const n in e)
                    "__proto__" !== n && "constructor" !== n && (n in t ? "string" == typeof t[n] || t[n]instanceof String || "string" == typeof e[n] || e[n]instanceof String ? o && (t[n] = e[n]) : h(t[n], e[n], o) : t[n] = e[n]);
                return t
            }
            function p(t) {
                return t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
            ...
            class b extends n {
                ...
                getResource(t, e, o) {
                    ...
                    o && "string" == typeof o && (s = s.concat(i ? o.split(i) : o)),
            ...
            class x extends n {
                ...
                extractFromKey(t, e) {
                    ...
                    if (r && !s) {
                        ...
                        const r = t.split(o);
                        (o !== n || o === n && this.options.ns.indexOf(r[0]) > -1) && (i = r.shift()),
                        t = r.join(n)
                    }
                ...
                translate(t, e, o) {
                    ...
                    if (y && h && "string" != typeof h && "boolean" != typeof h && "number" != typeof h && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) < 0 && ("string" != typeof g || "[object Array]" !== d)) {
                        ...
                        !this.isValidLookup(h) && p && (n = !0,
                        h = g),
                        this.isValidLookup(h) || (s = !0,
                        h = r);
                        const y = (e.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && s ? void 0 : h
                          , m = p && g !== h && this.options.updateMissing;
                        if (s || n || m) {
                            if (this.logger.log(m ? "updateKey" : "missingKey", l, a, r, m ? g : h),
                            i) {
                            ...
                            const n = (t,o,n)=>{
                                const i = p && n !== h ? n : y;
                                this.options.missingKeyHandler ? this.options.missingKeyHandler(t, a, o, i, m, e) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(t, a, o, i, m, e),
                                this.emit("missingKey", t, a, o, h)
                            }
                            ;
                            this.options.saveMissing && (this.options.saveMissingPlurals && u ? t.forEach((t=>{
                                this.pluralResolver.getSuffixes(t, e).forEach((o=>{
                                    n([t], r + o, e[`defaultValue${o}`] || g)
                                }
                                ))
                            }
                            )) : n(t, r, g))
                        ...
                        s && h === r && this.options.appendNamespaceToMissingKey && (h = `${a}:${r}`),
                        (s || n) && this.options.parseMissingKeyHandler && (h = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${r}` : r, n ? h : void 0) : this.options.parseMissingKeyHandler(h))
                    }
                    return n ? (c.res = h,
                    c.usedParams = this.getUsedParamsDetails(e),
                    c) : h
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse)
                        ...
                        !1 !== o.nest && (t = this.interpolator.nest(t, (function() {
                            for (var t = arguments.length, n = new Array(t), s = 0; s < t; s++)
                                n[s] = arguments[s];
                            return i && i[0] === n[0] && !o.context ? (r.logger.warn(`It seems you are nesting recursively key: ${n[0]} in key: ${e[0]}`),
                            null) : r.translate(...n, e)
                        }
                        ), o)),
                        ...
                        u.forEach((t=>{
                            ...
                            f.forEach((o=>{
                                ...
                                if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                                    this.i18nFormat.addLookupKeys(r, l, o, t, s);
                                else {
                                    let t;
                                    ...
                                    if (c && (r.push(l + t),
                                    s.ordinal && 0 === t.indexOf(n) && r.push(l + t.replace(n, this.options.pluralSeparator)),
                                    h && r.push(l + e)),
                                    p) {
                                        const o = `${l}${this.options.contextSeparator}${s.context}`;
                                        r.push(o),
                                        c && (r.push(o + t),
                                        s.ordinal && 0 === t.indexOf(n) && r.push(o + t.replace(n, this.options.pluralSeparator)),
                                        h && r.push(o + e))
                                    }
                                }
                                let a;
            ...
            function C(t, e, o) {
                ...
                return !r && i && "string" == typeof o && (r = y(t, o, n),
                void 0 === r && (r = y(e, o, n))),
                r
            }
            class N {
                ...
                init() {
                    ...
                    this.prefix = e.prefix ? p(e.prefix) : e.prefixEscaped || "{{",
                    this.suffix = e.suffix ? p(e.suffix) : e.suffixEscaped || "}}",
                    ...
                    this.nestingPrefix = e.nestingPrefix ? p(e.nestingPrefix) : e.nestingPrefixEscaped || p("$t("),
                    this.nestingSuffix = e.nestingSuffix ? p(e.nestingSuffix) : e.nestingSuffixEscaped || p(")"),
                            ...
                            if (t.indexOf("(") > -1) {
                                ...
                                "currency" === e && i.indexOf(":") < 0 ? o.currency || (o.currency = i.trim()) : "relativetime" === e && i.indexOf(":") < 0 ? o.range || (o.range = i.trim()) : i.split(";").forEach((t=>{
                                    if (!t)
                                        return;
                                    const [e,...n] = t.split(":")
                                      , i = n.join(":").trim().replace(/^'+|'+$/g, "");
                                    o[e.trim()] || (o[e.trim()] = i),
                                    "false" === i && (o[e.trim()] = !1),
                                    "true" === i && (o[e.trim()] = !0),
                                    isNaN(i) || (o[e.trim()] = parseInt(i, 10))
                                }
                                ))
                            }
                            return {
            ...
            class $ extends n {
                ...
                queueLoad(t, e, o, n) {
                    ...
                    return t.forEach((t=>{
                        ...
                        e.forEach((e=>{
                            const s = `${t}|${e}`;
                            !o.reload && this.store.hasResourceBundle(t, e) ? this.state[s] = 2 : this.state[s] < 0 || (1 === this.state[s] ? void 0 === r[s] && (r[s] = !0) : (this.state[s] = 1,
                            n = !1,
                            void 0 === r[s] && (r[s] = !0),
                            void 0 === i[s] && (i[s] = !0),
                            void 0 === a[e] && (a[e] = !0)))
                ...
                loadOne(t) {
                    ...
                    this.read(n, i, "read", void 0, void 0, ((o,r)=>{
                        o && this.logger.warn(`${e}loading namespace ${i} for language ${n} failed`, o),
                        !o && r && this.logger.log(`${e}loaded namespace ${i} for language ${n}`, r),
                        this.loaded(t, o, r)
                    }
                    ))
                }
                    ...
                    if (this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(e))
                        ...
                        if (this.backend && this.backend.create) {
                            ...
                            if (l.length < 6)
                                try {
                                    let i;
                                    i = 5 === l.length ? l(t, e, o, n, a) : l(t, e, o, n),
            ...
            class F extends n {
                ...
                init() {
                    ...
                    !this.options.isClone) {
                        ...
                        s.backendConnector = new $(r(this.modules.backend),s.resourceStore,s,this.options),
                ...
                cloneInstance() {
                    ...
                    o && (i.store = new b(this.store.data,n),
            ...
            var Q = function(t, e) {
              ...
              , Z = function(t, e, o) {
                ...
                "function" == typeof fetch ? fetch(t, e).then(n).catch(o) : J(t, e).then(n).catch(o)
            }
              , tt = !1
              , et = function(t, e, o, n) {
                ...
                n = n || function() {}
                ,
                J && 0 !== e.indexOf("file:") ? function(t, e, o, n) {
                    ...
                    o && (i["Content-Type"] = "application/json");
                    ...
                    o && "object" === Y(o) && (o = Q("", o).slice(1)),
                    t.queryStringParams && (e = Q(e, t.queryStringParams));
                    try {
                        var i;
                        (i = z ? new z : new X("MSXML2.XMLHTTP.3.0")).open(o ? "POST" : "GET", e, 1),
                            ...
                            s.forEach((function(e) {
                                t.allOptions.ns.forEach((function(t) {
                                    o.read(e, t, "read", null, null, (function(n, r) {
                                        n && i.warn("loading namespace ".concat(t, " for language ").concat(e, " failed"), n),
                                        !n && r && i.log("loaded namespace ".concat(t, " for language ").concat(e), r),
                                        o.loaded("".concat(e, "|").concat(t), n, r)
                                    }
                                    ))
                                }
                                ))
              ...
              , dt = {
                ...
                cacheUserLanguage: function(t, e) {
                    e.lookupCookie && "undefined" != typeof document && function(t, e, o, n) {
                        ...
                        i.expires.setTime(i.expires.getTime() + 60 * o * 1e3)),
                        n && (i.domain = n),
