            ...
            8291: function(t, e, n) {
                ...
                !function(n, r) {
                    ...
                    var u = {
                        ...
                        show: function(t, e, n) {
                            ...
                            var r = a(e)
                              , i = 0
                              , c = 0;
                            "touches"in t && t.touches.length ? (i = t.touches[0].pageY - r.top,
                            c = t.touches[0].pageX - r.left) : (i = t.pageY - r.top,
                            c = t.pageX - r.left),
                            c = c >= 0 ? c : 0,
                            i = i >= 0 ? i : 0;
                        ...
                        hide: function(t, e) {
                            for (var n = (e = e || this).getElementsByClassName("waves-rippling"), r = 0, i = n.length; r < i; r++)
                                l(t, e, n[r]);
                            o && (e.removeEventListener("touchend", u.hide),
                        ...
                        input: function(t) {
                            ...
                            if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
                                ...
                                var o = window.getComputedStyle(t, null)
                                  , r = o.color
                                  , i = o.backgroundColor;
                                n.setAttribute("style", "color:" + r + ";background:" + i),
                    ...
                    function f(t) {
                        ...
                        if (null !== e) {
                            ...
                            "touchstart" === t.type && u.delay) {
                                ...
                                u.show(t, e),
                                o && (e.addEventListener("touchend", u.hide, !1),
                    ...
                    return t.init = function(t) {
                        ...
                        o && (e.addEventListener("touchstart", f, !1),
                    ...
                    t.attach = function(t, e) {
                        ...
                        for (var a = 0, s = t.length; a < s; a++)
                            r = (o = t[a]).tagName.toLowerCase(),
                            -1 !== ["input", "img"].indexOf(r) && (c[r](o),
                            o = o.parentElement),
                            -1 === o.className.indexOf("waves-effect") && (o.className += " waves-effect" + e)
                    }
                    ,
                    t.ripple = function(t, e) {
                        ...
                        n)
                            for (var o, r, s, c = {}, l = 0, d = {
                                ...
                                d.pageY = c.y,
                                u.show(d, o),
                                e.wait >= 0 && null !== e.wait && setTimeout(f({
                                    type: "mouseup",
                                    button: 1
                                }, o), e.wait)
                    }
