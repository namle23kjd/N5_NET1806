...
namespace PetSpa.Migrations
{
    ...
    partial class PetSpaContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7266cacb-1592-4167-ac7d-b1c8dd09d72b"),
                            ConcurrencyStamp = "7266cacb-1592-4167-ac7d-b1c8dd09d72b",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = new Guid("316c5bb0-85a5-4e19-9a91-52009845cf94"),
                            ConcurrencyStamp = "316c5bb0-85a5-4e19-9a91-52009845cf94",
                            Name = "Staff",
                            NormalizedName = "STAFF"
                        },
                        new
                        {
                            Id = new Guid("893c1c8c-acbe-4928-99c6-a0bc1beda201"),
                            ConcurrencyStamp = "893c1c8c-acbe-4928-99c6-a0bc1beda201",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("716127bc-9392-4672-ab1c-c94e5f3cedb6"),
                            ConcurrencyStamp = "716127bc-9392-4672-ab1c-c94e5f3cedb6",
                            Name = "Manager",
            ...
            modelBuilder.Entity("PetSpa.Models.Domain.Voucher", b =>
                {
                    ...
                    b.Property<Guid>("CustomersCusId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ManagersManaId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CustomersCusId");

                    b.HasIndex("ManagersManaId");
            ...
            modelBuilder.Entity("PetSpa.Models.Domain.Staff", b =>
                {
                    ...
                    b.HasOne("PetSpa.Models.Domain.Manager", null)
                        .WithMany("Staffs")
            ...
            modelBuilder.Entity("PetSpa.Models.Domain.Voucher", b =>
                {
                    ...
                    b.HasOne("PetSpa.Models.Domain.Customer", "Customers")
                        .WithMany()
                        .HasForeignKey("CustomersCusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PetSpa.Models.Domain.Manager", "Managers")
                        .WithMany()
                        .HasForeignKey("ManagersManaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
